...
public class CadastroServidorView extends javax.swing.JFrame {

    
    public CadastroServidorView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroServidorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroServidorView().setVisible(true);
            }
        });
    }
