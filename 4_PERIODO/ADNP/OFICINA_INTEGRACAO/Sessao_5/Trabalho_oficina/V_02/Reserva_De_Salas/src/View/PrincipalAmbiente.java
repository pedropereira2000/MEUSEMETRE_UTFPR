...
public class PrincipalAmbiente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtPesquisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 410, -1));
        ...
        getContentPane().add(btnPesquisar, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 100, -1, -1));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        // Botão Pesquisar
         try{
            ...
            AmbienteDAO dao = new AmbienteDAO();
            List<Ambiente> consultarAmbientesId = dao.consultarAmbiente(id);
