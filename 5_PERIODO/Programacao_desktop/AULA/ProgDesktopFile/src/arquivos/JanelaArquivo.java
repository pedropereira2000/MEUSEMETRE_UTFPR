...
public class JanelaArquivo extends javax.swing.JFrame {
    ...
    private void jButton_ListaPastaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_ListaPastaMouseClicked
        String conteudo = "";
        String pasta = JOptionPane.showInputDialog(this,"Digite uma pasta", "Seleciona Pasta", JOptionPane.QUESTION_MESSAGE);
        String extensao = JOptionPane.showInputDialog(this,"Digite a extensao para o procurarmos arquivos", "Seleciona Tipo Arquivo", JOptionPane.QUESTION_MESSAGE);
        if(!extensao.equals("") && !pasta.equals("")){
            conteudo = "|| Pasta: "+pasta+" ||\n" + ProcuraPastaArquivos.leituraPastaExtensao(pasta, extensao);
        }
        else if(!pasta.equals("")){
            conteudo = "|| Pasta: "+pasta+" ||\n" + ProcuraPastaArquivos.leituraPasta(pasta);
        }else{
            conteudo = "Não foram informados os campos da pasta e tipo do arquivo";
        }
        jTextArea_ListaPasta.setText(conteudo);
