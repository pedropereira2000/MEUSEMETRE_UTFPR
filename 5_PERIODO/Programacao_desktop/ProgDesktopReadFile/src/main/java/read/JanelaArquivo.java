...
public class JanelaArquivo extends javax.swing.JFrame {
    ...
    private void jButton_ListaPastaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_ListaPastaMouseClicked
        var arquivo = JOptionPane.showInputDialog(this,"Digite a extensao para o procurarmos arquivos", "Seleciona Tipo Arquivo", JOptionPane.QUESTION_MESSAGE);
        
        var result = ControllFile.buscaArquivo(arquivo);
